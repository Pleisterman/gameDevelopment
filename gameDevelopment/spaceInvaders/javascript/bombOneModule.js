...
( function( gameDevelopment ){
    gameDevelopment.bombOneModule = function() {

        /*
         *  module bombOneModule 
         *      
         *  functions: 
         *      private:
        ...
        self.step = 0.5;                                // percentage of background height, down movement of the bomb
        self.hitStrength = 1;                           // strength of the hit will be consumed by a colliding bunker or shipModule
        self.alive = true;                              // bool, store if bomb is alive ( on screen and no collision )
        ...
        self.animate = function() {
            ...
            // get the image
            var image = jsProject.getResource( 'bombOne', 'image' );
