 ...
 * GitHub: Pleisterman 
 * 
 * Purpose: this module displays the a screen when the user looses the game for the application space invaders
 *          text will be displayed sending the user to trainingkamp
 *          
...
( function( gameDevelopment ){
    gameDevelopment.gameLostModule = function( ) {


        /*
         *  module gameLostModule 
         *   
         *  functions: 
         *      private:
        ...
        self.text = {           "id" :                  "gameLost",             // store the textId  
                                ...
                                "height" :              80,                     // percentage of background height, height of the textarea
                                "titleFontSize" :       10,                     // percentage extra relative to fontSize 
                                "fontSize" :            3.6,                    // percentage of background height, initial fontSize
                                "fittingFontSize" :     3.6,                    // percentage of background height, font size that fits the width and height 
