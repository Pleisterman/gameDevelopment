...
( function( gameDevelopment ){
    gameDevelopment.invaderOneModule = function( ) {

        /*
         *  module invaderOneModule 
         *   
         *   
         *  functions: 
         *      private:
        ...
        self.blockWidth = 1;                    // number of invaderblock this invader occupies in horizontal direction
        self.blockHeight = 1;                   // number of invaderblock this invader occupies in vertical direction    
        self.alive = true;                      // store if invader is alive
        self.strength = 2;                      // store the strength of invader
        self.hits = 0;                          // store the number of hits taken by invader
        self.bombType = 1;                      // store bomb type for bomb release function
        self.hitScore = 20;                     // store the score for when a bullet hits invader
        self.difficultyHitScore = 5;            // store the extra score per diificulty level
        self.killScore = 100;                   // store the score for when invader destructs
        self.difficultyKillScore = 20;          // store the extra score per diificulty level
