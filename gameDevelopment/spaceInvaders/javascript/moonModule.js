 ...
 * GitHub: Pleisterman 
 * 
 * Purpose: this module controls the drawing of the moon for the application space invaders
 *          the moon is animated along the bottom middle of the screen 
 *          
...
( function( gameDevelopment ){
    gameDevelopment.moonModule = function() {
        ...
        // private
        var self = this;
        self.MODULE = 'moonModule';
        self.debugOn = false;
        self.visible = false;                   // visibility
        self.canvasSurface = null;              // canvas surface to draw on
        self.position = {  "top" :     30,      // constant percentage of background height
                           "left" :  90.0,      // calculated image is placed in middle of the background
                           "height" :  65,      // constant percentage of background height
                           "width" :   65 };    // constant percentage of background width
        self.curveHeight = 13.2;                // percentage of background height that the moon will rise up in the middle
        ...
        self.drawRect = { "top" :       0,      // px, the rect that the image is drawn in  
                          ...
                          "height" :    0,      // px
                          "width" :     0 };    // px
        self.globalAlpha = 0.9;                 // alpha with wich the image is drawn
        self.animationStep = -0.04;             // space that the image will move per animation step 
        self.animationDelay = 900;             // ms
        ...
        self.construct = function() {
            ...
            self.canvasSurface = document.getElementById( 'moonDrawLayer' ).getContext( '2d' );
        ...
        self.animate = function( skipDelay ){
            ...
            top += Math.abs( Math.sin( ( 80 - self.position["left"] ) / 70 ) ) * curveHeight;
            
            // get the image
            var image = jsProject.getResource( 'moon', 'image' );
            // draw the image
